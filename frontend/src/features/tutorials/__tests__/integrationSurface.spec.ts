...
describe('Tutorials extension integration surface', () => {
  it('keeps the page in the extension and embeds the configured surfaces', () => {
    ...
    expect(view).toContain('fetchPublicTutorialVideos')
    expect(view).toContain('recordTutorialVideoPlay')
    expect(view).toContain("tutorials.videos.playCount")
    ...
    expect(api).toContain("'/tutorials/videos'")
